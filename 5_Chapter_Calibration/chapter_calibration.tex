...
\begin{figure}[b!]
    ...
    (RIGHT) Fluctuations among runs are within 1\% (gray band).}
    \label{fig:figure51}
\end{figure}
...
\begin{figure}[t!]
	...
	\caption{Time evolution of the neutron capture rate and neutron tagging efficiency measured by MoGURA over KamLAND-Zen 800 data-taking.}
...
\begin{figure}[t!]
	...
	\caption{Characteristic distributions of $^{10}$C decay candidates. Red and blue histograms correspond to on-time and off-time events, respectively. The black markers (or gray histograms) show the background-subtracted distributions (on-time minus off-time).}
...
\begin{figure}[t!]
    ...
    \end{subfigure}
    \caption{Time evolution of the $^{10}$C decay rate (left) and the shape of the $dR$ distribution (right) over KamLAND-Zen 800 data-taking.}
...
\begin{figure}[t!]
	...
	\caption{$\Delta\chi^2$ scan over Birks’ constant $k_B$ and the Cherenkov-to-scintillation ratio $R$.}
