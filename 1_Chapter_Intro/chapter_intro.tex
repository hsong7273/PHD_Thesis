...
While neither \2nbb or \2nbb$^*$ has had their decay rates successfully predicted, close correlation between the NMEs of \2nbb and \0nbb have been demonstrated. Figure \ref{fig:corr_2nu_0nu} shows the correlations between \2nbb and \0nbb NME as calculated by two different methods.
...
\end{figure}
All this further motivates a better understanding of \2nbb and \2nbb$^*$ to aid in theoretical calculations of $M^{0\nu}$.
