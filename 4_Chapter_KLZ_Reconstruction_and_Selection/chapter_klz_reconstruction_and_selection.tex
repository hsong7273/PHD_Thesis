...
Table \ref{tab:fluka_error} lists the estimated systeamtic errors of the FLUKA simulation of long-lived spallation isotope production. The most significant of these systematic errors is the uncertainty in the FLUKA spallation simulation. 
\begin{table}[h]
	\centering
	\begin{tabular}{lc}
		\hline
