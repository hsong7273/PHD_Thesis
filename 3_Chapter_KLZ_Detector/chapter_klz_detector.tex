...
\begin{figure}[t!]
	...
	\caption[Illustration of the KamLAND site.]{Illustration of the KamLAND site. Figure from Reference~\cite{ozaki_phd}.}
...
\begin{figure}[t!]
	...
	\caption[KamLAND-Zen detector.]{KamLAND-Zen detector. Figure from Reference~\cite{ozaki_phd}.}
	\label{fig:kamland}
\end{figure}
...
\begin{figure}[t!]
	...
	\caption[Schematics of the 17-inch and 20-inch PMTs.]{Schematics of the 17-inch and 20-inch PMTs. Figure from Reference~\cite{ozaki_phd}.}
	\label{fig:pmts}
\end{figure}
...
\begin{figure}[t!]
	...
	\caption[Quantum Efficiency of the KamLAND inner PMTs and PPO emission over wavelength.]{Quantum Efficiency of the KamLAND inner PMTs and PPO emission over wavelength. Figure from Reference~\cite{mastuda_phd}.}
...
\begin{table}[b!]
	...
	\end{tabular}
	\caption[Composition and physical properties of the KamLAND liquid scintillator (KamLS).]{Composition and physical properties of the KamLAND liquid scintillator (KamLS). Values are taken from Reference~\cite{ozaki_phd}.}
	\label{tbl:kamls}
\end{table}
...
\begin{table}[t!]
	...
	\end{tabular}
	\caption[Chemical composition of the xenon-loaded liquid scintillator (XeLS) for the different phases of the KamLAND-Zen experiment.]{Chemical composition of the xenon-loaded liquid scintillator (XeLS) for the different phases of the KamLAND-Zen experiment. Values are taken from Reference~\cite{miyake_phd}.}
	\label{tbl:xels}
\end{table}
...
\begin{figure}[t!]
	...
	\caption[Flow diagram of the water extraction and nitrogen purge system.]{Flow diagram of the water extraction and nitrogen purge system. Figure from Reference~\cite{gando_phd}.}
	\label{fig:waterex}
\end{figure}
...
\begin{figure}[b!]
	...
	\caption[Flow diagram of the KLZ distillation and circulation system.]{Flow diagram of the KLZ distillation and circulation system. Figure from Reference~\cite{ozaki_phd}.}
...
\begin{figure}[t!]
	...
	\caption[Flow diagram of the KLZ Xenon system.]{Flow diagram of the KLZ Xenon system. The purple lines denote the flow of Xe/XeLS, the blue line denotes the flow of decane, the the grey line denotes the flow of LS. Figure from Reference~\cite{ozaki_phd}.}
...
\begin{figure}[t!]
	...
	\caption[Flow diagram of the KamLAND data acquisition system.]{Flow diagram of the KamLAND data acquisition system, taken from Reference~\cite{li_phd}.}
...
\begin{figure}[t!]
	...
	\caption[Inner balloon structure and measurements for KamLAND-Zen 800 configuration.]{Inner balloon structure and measurements for KamLAND-Zen 800 configuration, taken from Reference~\cite{ozaki_phd}.}
...
\begin{figure}[t!]
	...
	\caption[Coincidence event rate in KamLAND-Zen 800 during the first distillation campaign, second distillation campaign, and xenon loading phase.]{Coincidence event rate in KamLAND-Zen 800 during the first distillation campaign, second distillation campaign, and xenon loading phase. The red points denote $^{214}$Bi and the blue points denote $^{212}$Bi. Figure from Reference~\cite{li_phd}.}
...
\begin{table}[b!]
	...
	\end{tabular}
	\caption[Balloon film contamination levels from the last three phases of KamLAND-Zen.]{Balloon film contamination levels from the last three phases of KamLAND-Zen. Values taken from Reference~\cite{ozaki_phd}.}
