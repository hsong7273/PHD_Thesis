...
\begin{figure}[t!]
	...
	\caption{Illustration of the KamLAND site. Figure from Reference~\cite{ozaki_phd}.}
...
\begin{figure}[t!]
	...
	\caption{KamLAND-Zen detector. Figure from Reference~\cite{ozaki_phd}}
	\label{fig:kamland}
\end{figure}
...
\begin{figure}[t!]
	...
	\caption{Schematics of the 17-inch and 20-inch PMTs. Figure from Reference~\cite{ozaki_phd}.}
	\label{fig:pmts}
\end{figure}
...
\begin{figure}[t!]
	...
	\caption{Quantum Efficiency of the KamLAND inner PMTs and PPO emission over wavelength. Figure from Reference~\cite{mastuda_phd}.}
...
\begin{table}[b!]
	...
	\end{tabular}
	\caption{Composition and physical properties of the KamLAND liquid scintillator (KamLS). Values from Reference~\cite{ozaki_phd}.}
	\label{tbl:kamls}
\end{table}
...
\begin{table}[b!]
	...
	\end{tabular}
	\caption{Chemical composition of the xenon-loaded liquid scintillator (XeLS) for the different phases of the KamLAND-Zen experiment. Values from Reference~\cite{miyake_phd}.}
	\label{tbl:xels}
\end{table}
...
\begin{figure}[t!]
	...
	\caption{Coincidence event rate in KamLAND-Zen 800 during the first distillation campaign, second distillation campaign, and Zenon loading phase. The red points denote $^{214}$Bi and the blue points denote $^{212}$Bi. Figure from Reference~\cite{li_phd}.}
